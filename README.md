...
<img src="PacketTracer-Installer-for-Arch-Linux/blob/main/packettracer-arch-installer/docs/images/how-it-works.svg" alt="Workflow of packettracer_installer.sh: input, validate, dependencies, deploy, CLI launcher" width="100%">
